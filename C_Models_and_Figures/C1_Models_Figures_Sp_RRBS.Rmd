...
ex_meth_by_GE_ATAC <- read.csv( 
  "~/Documents/GitHub/Sp_RRBS_ATAC/B_Integr_ATAC_RRBS_RNA/Output_data/ex_meth_by_GE_ATAC.csv" )
int_meth_by_GE_ATAC <- read.csv( 
  "~/Documents/GitHub/Sp_RRBS_ATAC/B_Integr_ATAC_RRBS_RNA/Output_data/int_meth_by_GE_ATAC.csv" )
pr_meth_by_GE_ATAC <- read.csv( 
  "~/Documents/GitHub/Sp_RRBS_ATAC/B_Integr_ATAC_RRBS_RNA/Output_data/pr_meth_by_GE_ATAC.csv" )
...
Fig_1A_top <- ggplot( data = avg_meth_by_GE, 
                  aes( x = meth, y = logCPM ) ) +
...
# Create lower half of Fig. 1A
Fig_1A_bot <- ggplot( data = avg_meth_by_splice, 
...
# Create Fig. 1C
Fig_1C <- ggplot( data = updown_binned_TRUE_FALSE, 
  ...
  labs( y = "% methylation", x = "ATAC read distance (bp)" ) +
...
Fig_1_left <- ggarrange( Fig_1A_top, Fig_1A_bot, 
                    labels = c( "A", "B" ),
                    ncol = 1, nrow = 2,
                    align = "hv")


Fig_1_right <- ggarrange( Fig_1B, Fig_1C, 
                    labels = c( "C", "D" ),
                    ncol = 1, nrow = 2,
                    align = "hv")

Fig_1 <- ggarrange( Fig_1_left, Fig_1_right, 
                    labels = c( "", "" ),
                    ncol = 2, nrow = 1,
                    align = "hv", widths = c( 0.6, 0.4 ) )


# Export Fig 1 as tiff
tiff( "Output_figures/Fig_1.tiff", units = "in", width = 12, 
      height = 7, 
      res = 600 )
...
# Export Fig 1 as png
png( "Output_figures/Fig_1.png", units = "in", width = 12, 
      height = 7, 
      res = 600 )
...
#Create Fig 2: Volcano plots of differential expression, splicing, and methylation
...
BF_mod_logCPM <- bayesfactor_models( const_ex_int_brm1, const_ex_int_brm3, const_ex_int_brm4,
                                     const_ex_int_brm5, const_ex_int_brm6, const_ex_int_brm7,
                                     denominator = const_ex_int_brm2 )

# Print
BF_mod_logCPM

# Inclusion Bayes factors
BF_incl_logCPM <- bayesfactor_inclusion( BF_mod_logCPM )

# Print: accessibility does not aid model predictions
BF_incl_logCPM

# Posterior predictive check
pp_check( const_ex_int_brm1 )

# Diagnostic plots
conditional_effects( const_ex_int_brm1 )
plot( const_ex_int_brm1 )
pp_check( const_ex_int_brm1 )
...
# Scale meth variables
pr_meth_by_splicing_ATAC$meth_Z <- scale( pr_meth_by_splicing_ATAC$median )
ex_meth_by_splicing_ATAC$meth_Z <- scale( ex_meth_by_splicing_ATAC$median )
int_meth_by_splicing_ATAC$meth_Z <- scale( int_meth_by_splicing_ATAC$median )

# Scale accessibility variables
pr_meth_by_splicing_ATAC$TSS_dens_norm_Z <- scale( pr_meth_by_splicing_ATAC$TSS_dens_norm )
ex_meth_by_splicing_ATAC$exon_dens_norm_Z <- scale( ex_meth_by_splicing_ATAC$exon_dens_norm )
int_meth_by_splicing_ATAC$intron_dens_norm_Z <- scale( int_meth_by_splicing_ATAC$intron_dens_norm )

## Fit bayesian binomial logistic regressions
# Splicing ~ promoter meth and TSS access
pr_splice_meth_glm1 <- brm( formula = splice ~ meth_Z,
                   data = pr_meth_by_splicing_ATAC, 
...
pr_splice_meth_glm2 <- brm( formula = splice ~ meth_Z + TSS_dens_norm_Z,
                   data = pr_meth_by_splicing_ATAC, 
                   family = bernoulli( link = "logit" ),
                   prior = c( prior(normal( 0, .5 ), class = Intercept ),
                                     prior(normal( 0, .5 ), class = b ) ),
...
pr_splice_meth_glm3 <- brm( formula = splice ~ meth_Z + TSS_dens_norm_Z + meth_Z : TSS_dens_norm_Z,
                   data = pr_meth_by_splicing_ATAC, 
                   family = bernoulli( link = "logit" ),
                   prior = c( prior(normal( 0, .5 ), class = Intercept ),
                                     prior(normal( 0, .5 ), class = b ) ),
...
# Model selection for splicing ~ promoter meth and access
pr_splice_meth_bf_incl <- bayesfactor_models( pr_splice_meth_glm1, pr_splice_meth_glm2,
                                              denominator = pr_splice_meth_glm3 )

# Print
pr_splice_meth_bf_incl

# Posterior predictive check of splicing ~ promoter meth
pp_check( pr_splice_meth_glm1 )
posterior_interval( pr_splice_meth_glm1,
                    prob = 0.90,
                    type = "central" )

# Splicing ~ exon meth and exon access
ex_splice_meth_glm1 <- brm( formula = splice ~ meth_Z,
                   data = ex_meth_by_splicing_ATAC, 
                   family = bernoulli( link = "logit" ),
                   prior = c( prior(normal( 0, .5 ), class = Intercept ),
                                     prior(normal( 0, .5 ), class = b ) ),
                   warmup = 2000, 
...
ex_splice_meth_glm2 <- brm( formula = splice ~ meth_Z + exon_dens_norm_Z,
                   data = ex_meth_by_splicing_ATAC, 
                   family = bernoulli( link = "logit" ),
                   prior = c( prior(normal( 0, .5 ), class = Intercept ),
                                     prior(normal( 0, .5 ), class = b ) ),
...
ex_splice_meth_glm3 <- brm( formula = splice ~ meth_Z + exon_dens_norm_Z + meth_Z : exon_dens_norm_Z,
                   data = ex_meth_by_splicing_ATAC, 
                   family = bernoulli( link = "logit" ),
                   prior = c( prior(normal( 0, .5 ), class = Intercept ),
                                     prior(normal( 0, .5 ), class = b ) ),
...
# Model selection for splicing ~ exon meth and access
ex_splice_meth_bf_incl <- bayesfactor_models( ex_splice_meth_glm1, ex_splice_meth_glm2,
                                              denominator = ex_splice_meth_glm3 )

# Print
ex_splice_meth_bf_incl

# Posterior predictive check of splicing ~ exon meth
pp_check( ex_splice_meth_glm1 )
posterior_interval( ex_splice_meth_glm1,
                    prob = 0.90,
                    type = "central" )

# Splicing ~ intron meth and TSS access
int_splice_meth_glm1 <- brm( formula = splice ~ meth_Z,
                   data = int_meth_by_splicing_ATAC, 
                   family = bernoulli( link = "logit" ),
                   prior = c( prior(normal( 0, .5 ), class = Intercept ),
                                     prior(normal( 0, .5 ), class = b ) ),
                   warmup = 2000, 
...
int_splice_meth_glm2 <- brm( formula = splice ~ meth_Z + intron_dens_norm_Z,
                   data = int_meth_by_splicing_ATAC, 
                   family = bernoulli( link = "logit" ),
                   prior = c( prior(normal( 0, .5 ), class = Intercept ),
                                     prior(normal( 0, .5 ), class = b ) ),
...
int_splice_meth_glm3 <- brm( formula = splice ~ meth_Z + intron_dens_norm_Z + meth_Z : intron_dens_norm_Z,
                   data = int_meth_by_splicing_ATAC, 
                   family = bernoulli( link = "logit" ),
                   prior = c( prior(normal( 0, .5 ), class = Intercept ),
                                     prior(normal( 0, .5 ), class = b ) ),
...
# Model selection for splicing ~ intron meth and access
int_splice_meth_bf_incl <- bayesfactor_models( int_splice_meth_glm1, int_splice_meth_glm2,
                                              denominator = int_splice_meth_glm3 )

# Print
int_splice_meth_bf_incl

# Posterior predictive check of splicing ~ intron meth
pp_check( int_splice_meth_glm1 )
posterior_interval( int_splice_meth_glm1,
                    prob = 0.90,
                    type = "central" )
...
exon_DE_BF_models <- bayesfactor_models( DE_brm_ex_1, DE_brm_ex_10, DE_brm_ex_3, DE_brm_ex_4, DE_brm_ex_5,
                                         DE_brm_ex_6, DE_brm_ex_7, DE_brm_ex_8, DE_brm_ex_9, DE_brm_ex_11,
                                         DE_brm_ex_12, DE_brm_ex_13, DE_brm_ex_14,
                                         denominator = DE_brm_ex_2 )
...
stDEU_dm_brm_12 <- brm( exon_coeff_Z ~ intron_dens_norm_Z + exon_DM_logFC_Z + exon_dens_norm_Z +
                          exon_dens_norm_Z : exon_DM_logFC_Z + exon_DM_logFC_Z : intron_dens_norm_Z +
                          exon_dens_norm_Z : intron_len_Z +
                          exon_dens_norm_Z : exon_DM_logFC_Z : intron_dens_norm_Z,
                          data = exon_DM_DEU_ATAC,
                          family = student(),
...
DEU_brm_bf <- bayesfactor_models( stDEU_dm_brm_1, stDEU_dm_brm_2, stDEU_dm_brm_3, stDEU_dm_brm_5, 
                                  ...
                                  stDEU_dm_brm_10h, stDEU_dm_brm_11, stDEU_dm_brm_12,
...
gb_DM_by_GE_ATAC_df$genebody_access <- ( gb_DM_by_GE_ATAC_df$peak_density_Introns +
                                           gb_DM_by_GE_ATAC_df$peak_density_Exons ) / gb_DM_by_GE_ATAC_df$gene_len
gb_DM_by_GE_ATAC_df$genebody_access[ is.na( gb_DM_by_GE_ATAC_df$genebody_access ) ] <- 0
...
gb_DM_by_GE_ATAC_df$genebody_access_Z <- scale( gb_DM_by_GE_ATAC_df$genebody_access )
...
# Model selection w/ Bayes factors
de_gbm_bf_mod <- bayesfactor_models( DE_brm_gb2, DE_brm_gb3, DE_brm_gb4, DE_brm_gb5,
                                     DE_brm_gb6, DE_brm_gb7, DE_brm_gb8, DE_brm_gb1, 
                                     DE_brm_gb10, denominator = DE_brm_gb9 )

# Print
de_gbm_bf_mod

# Inclusion Bayes factors
de_gbm_bf_incl <- bayesfactor_inclusion( de_gbm_bf_mod )

# Print
de_gbm_bf_incl

# Export posterior intervals: no significant interaction between gb dm, chromatin access, and GE despite inclusion BF
posterior_interval(
  DE_brm_gb6,
  prob = 0.90,
  type = "central" )
...
# ANOVA of lm GE ~ logTSS accessibilty to estimate slope: slope = 0.32277
summary( lm( logCPM ~ log( TSS_dens_norm ),
           data = filter( ATAC_dens_by_GE, TSS_dens_norm > 0 ) ) )
...
# ANOVA of lm GE ~ log gb accessibilty to estimate slope: slope = 0.21631
summary( lm( logCPM ~ log( gene_body_access ),
           data = filter( ATAC_dens_by_GE, gene_body_access > 0 ) ) )

# TSS accessibility is x % stronger in its effect on GE: 32.98% stronger
1 - ( 0.21631 / 0.32277 )
